...
import (
	...
	scalelib "example.com/cronhpa/lib"
...
func (cm *CronManager) updateCronHPAStatusWithRetry(instance *autoscalingv1.CronHorizontalPodAutoscaler, deepCopy *autoscalingv1.CronHorizontalPodAutoscaler, jobName string) error {
	var err error
	if instance == nil {
